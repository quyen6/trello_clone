...
export const pagingSkipValue = (page, itemsPerPage) => {
   ...
   * Case 01: User đứng ở page 1 (page = 1) thì sẽ lây 1 - 1 = 0 sau đó nhân với 12 thì cũng = 0, lúc này giá trị skip là 0, nghĩa là không skip bản ghi
   * Case 02: User đứng ở page 2 (page = 2) thì sẽ lây 2 - 1 = 1 sau đó nhân với 12 thì = 12, lúc này giá trị skip là 12, nghĩa là skip 12 bản ghi của 1 page trước đó
   * ..
