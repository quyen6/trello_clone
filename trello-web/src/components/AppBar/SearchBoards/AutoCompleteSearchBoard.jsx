...
function AutoCompleteSearchBoard() {
  ...
  const handleInputSearchChange = (event) => {
    ...
    fetchBoardsAPI(searchPath)
      ...
      .finally(() => {
        // Lưu ý về việc setLoading về false luôn chạy trong finally để dù có lỗi hay không thì cũng không hiện cái loading nữa
        setLoading(false);
      });
  };
  // Làm useDebounceFn...
  const debounceSearhBoard = useDebounceFn(handleInputSearchChange, 1000);
  ...
  return (
    <Autocomplete
      ...
      onInputChange={debounceSearhBoard}
