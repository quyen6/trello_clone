...
function ActiveCard() {
  ...
  const onUpdateCardDescription = (newDesc) => {
    // Gọi API...
    callApiUpdateCard({ description: newDesc });
  };
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid size={{ xs: 12, sm: 9 }}>
            ...
            <Box sx={{ mb: 3 }}>
              ...
              <CardDescriptionMdEditor
                cardDescProp={activeCard?.description}
                handleUpdateCardDesc={onUpdateCardDescription}
              />
            </Box>
          ...
          <Grid size={{ xs: 12, sm: 3 }}>
            ...
            <Stack direction="column" spacing={1}>
              ...
              {/* Nếu user hiện tại đang đăng nhập chưa thuộc mảng memberIds của card thid mới cho hiện nút Join ra */}
