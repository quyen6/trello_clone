...
import { selectorCurrentUser, updateUserAPI } from "~/redux/user/userSlice";
  ...
  const uploadAvatar = (e) => {
    ...
    toast
      ...
      .then((res) => {
        ...
        // Lưu ý, dù có lỗi hoặc thành công  thì cũng phải clear giá trị của file input nếu không thì sẽ khong thể chọn cùng một file liên tiếp được
        e.target.value = "";
      });
  };
